<div>
        <section class="relative min-h-[60vh] flex items-center">
            ...
            <div class="container mx-auto relative z-10 px-6 py-12 md:py-20 max-w-xl text-center border border-white/30 backdrop-blur-md bg-white/10">
                <h1 class="text-3xl sm:text-4xl md:text-6xl lg:text-7xl font-semibold font-[Poppins] text-white mb-2" data-aos="fade-right" data-aos-duration="2000">
                    Tentang
                </h1>
                <h2 class="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-semibold font-[Poppins] text-white mt-1" data-aos="fade-left" data-aos-duration="2000">
                    SMKN 4 KUNINGAN
                </h2>
            </div>
        </section>
    ...
    {{-- Tentang Sekolah --}}
        <div class="container mx-auto px-6 md:px-12 py-12 md:py-20 max-w-5xl">
            <div class="relative bg-gray-50 backdrop-blur-xl border border-white/30 rounded-3xl shadow-2xl p-6 md:p-14"
                data-aos="fade-up" data-aos-duration="1200">

                <div class="absolute -top-6 left-6 text-5xl sm:text-6xl md:text-6xl lg:text-7xl z-10 text-blue-600 opacity-20 select-none">“</div>
    ...
    {{-- Kepala Sekolah --}}
        <section class="container mx-auto flex flex-col md:flex-row items-center gap-8 md:gap-12 py-12 md:py-20">
            <div class="md:w-1/2" data-aos="fade-right" data-aos-offset="300" data-aos-easing="ease-in-sine" data-aos-duration="2000">
                ...
                <p class="text-sm sm:text-base md:text-lg text-gray-700 leading-relaxed">
                    Bapak Yayan Sopyan menjabat sebagai Kepala SMK Negeri 4 Kuningan sejak Februari 2023. Dengan latar belakang pendidikan agama dan magister pendidikan, beliau memimpin sekolah dengan visi mencetak lulusan yang terdidik, kreatif, mandiri, kompetitif, dan berakhlak mulia. Di bawah kepemimpinannya, SMK Negeri 4 Kuningan terus berupaya meningkatkan kualitas pendidikan dan relevansi dengan dunia industri.
                </p>
            </div>

            <div class="md:w-1/2 relative flex justify-center items-center" data-aos="flip-right" data-aos-easing="ease-out-cubic" data-aos-duration="2000" data-aos-offset="300">
                <div class="absolute bg-gray-300 w-64 sm:w-72 md:w-80 h-64 sm:h-72 md:h-80 mt-6 ml-6 rounded-full -z-10"></div>
                <img class="max-w-full rounded-lg shadow-lg" src="{{ asset('img/kepsek.png') }}" alt="Kepala Sekolah">
            </div>
        </section>

    {{-- Visi, Misi, Tujuan --}}
    <div class="container mx-auto max-w-5xl my-16 md:my-28 px-4 sm:px-6 md:px-12">
        ...
        <div class="bg-white/70 backdrop-blur-md shadow-xl rounded-2xl p-6 md:p-10 mb-8 md:mb-12 border border-gray-200" data-aos="fade-up" data-aos-duration="1400">
            ...
            <ul class="list-disc pl-5 sm:pl-6 md:pl-8 space-y-2 sm:space-y-4 text-sm sm:text-base md:text-lg text-gray-700 leading-relaxed font-sans">
                <li>Mengupayakan peningkatan keimanan, ketaqwaan, akhlak serta membangun karakter dan budaya bangsa.</li>
                <li>Mengembangkan kurikulum nasional sesuai kebutuhan masyarakat, tuntutan pasar kerja serta perkembangan ilmu pengetahuan dan teknologi.</li>
                <li>Melaksanakan sistem pendidikan pembelajaran dan pelatihan menengah kejuruan yang berwawasan keunggulan serta berorientasi masa depan.</li>
                <li>Mengembangkan sumber daya pendidikan secara optimal dan berkelanjutan agar mampu berkompetisi di era globalisasi.</li>
                <li>Menjalin kemitraan dengan dunia industri, institusi, dan masyarakat dalam upaya meningkatkan kualitas pendidikan.</li>
            </ul>
        </div>
        ...
        <div class="bg-white/70 backdrop-blur-md shadow-xl rounded-2xl p-6 md:p-10 border border-gray-200" data-aos="fade-up" data-aos-duration="1600">
            ...
            <ul class="list-decimal pl-5 sm:pl-6 md:pl-8 space-y-2 sm:space-y-4 text-sm sm:text-base md:text-lg text-gray-700 leading-relaxed font-sans">
                ...
                <li>Meningkatkan ilmu pengetahuan, teknologi serta keterampilan untuk memasuki dunia kerja, hidup mandiri, atau melanjutkan ke perguruan tinggi.</li>
                <li>Meningkatkan kesadaran warga sekolah terhadap pemeliharaan lingkungan hidup, 7K (kebersihan, keindahan, ketertiban, kesehatan, kekeluargaan, kedisiplinan, keamanan).</li>
