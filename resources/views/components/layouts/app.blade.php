...
<footer id="kontak" class="bg-gradient-to-r from-blue-700 to-blue-500 text-white py-20">
    <div class="max-w-7xl mx-auto px-6 grid md:grid-cols-3 gap-8">
        <div class="space-y-4 text-center md:text-left">
            <h2 class="text-3xl font-bold">SMKN 4 Kuningan</h2>
            <p class="text-gray-100">Jl. Contoh No. 123, Kuningan, Jawa Barat</p>
            <p class="text-gray-100">
                Email: 
                <a href="mailto:info@smkn4kuningan.sch.id" class="underline hover:text-blue-200">info@smkn4kuningan.sch.id</a> | 
                Telp: (0232) 123456
            </p>
            <p class="text-sm text-gray-200 mt-4">© 2025 SMKN 4 Kuningan. All rights reserved.</p>
        </div>
        ...
        <div class="flex flex-col items-center md:items-end space-y-4 mt-6">

            <h1 class="font-[Poppins] mx-auto text-2xl font-semibold">Sosial Media</h1>
            ...
            <div class="flex space-x-4">
                ...
                <!-- Facebook -->
                <a href="https://www.facebook.com/smkn4kng/" target="_blank" class="p-3 rounded-full bg-white text-blue-600 shadow-lg transform transition duration-500 hover:scale-110 hover:rotate-12">
                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                        <path d="M22 12c0-5.522-4.478-10-10-10S2 6.478 2 12c0 4.991 3.657 9.128 8.438 9.879v-6.988h-2.54v-2.891h2.54V9.797c0-2.507 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.772-1.63 1.562v1.876h2.773l-.443 2.891h-2.33v6.988C18.343 21.128 22 16.991 22 12z"/>
                    </svg>
                </a>

                <!-- YouTube -->
                <a href="#" target="_blank" class="p-3 rounded-full bg-white text-red-600 shadow-lg transform transition duration-500 hover:scale-110 hover:rotate-12">
                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
